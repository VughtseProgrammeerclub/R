...
ggplot(scholen_lezen, aes(x = school, y = gemiddelde_lezen)) +
  ...
  theme_classic() + 
  theme(
    axis.text.x = element_text(size = 12, angle = 25, hjust = 1),  # grotere x-as labels
    ...
    plot.title = element_text(size = 16, face = "bold"))           # grotere en vetgedrukte titel
...
#  Tip: maak een nieuwe dataframe genaamd "scholen_rekenen", en kijk hierin wat een goede y-as limiet zou zijn:
...
ggplot(dataset_scholen, aes(x = getallen, y = rekenen)) +
  ...
  theme_classic() + 
  theme(
    axis.text.x = element_text(size = 12),                 # grotere x-as labels
    axis.text.y = element_text(size = 12),                 # grotere y-as labels
    axis.title.x = element_text(size = 14),                # grotere x-as titel
    axis.title.y = element_text(size = 14),                # grotere y-as titel
    plot.title = element_text(size = 16, face = "bold"))   # grotere en vetgedrukte titel
...
dataset_gemeentes %>%
  ...
  theme_classic() + 
  theme(
    axis.text.x = element_text(size = 9),                  # grootte van x-as labels
    axis.text.y = element_text(size = 10),                 # grootte van y-as labels
    axis.title.x = element_text(size = 12),                # grootte van x-as titel
    axis.title.y = element_text(size = 12),                # grootte van y-as titel
    plot.title = element_text(size = 14, face = "bold"))   # grootte van en vetgedrukte titel
...
ggplot(dataset_gemeentes, aes(x = Gemiddeld_inkomen, y = Gemiddelde_WOZ_2024)) +
  ...
  theme_classic() + 
  theme(
    axis.text.x = element_text(size = 11),                 # grootte van x-as labels
    axis.text.y = element_text(size = 11),                 # grootte van y-as labels
    axis.title.x = element_text(size = 12),                # grootte van x-as titel
    axis.title.y = element_text(size = 12),                # grootte van y-as titel
    plot.title = element_text(size = 14, face = "bold"))   # grootte van en vetgedrukte titel
